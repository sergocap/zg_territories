...
// Render hero search form ---------------------------------------------------------------------------------------------
    ...
    $("select").on("rendered.bs.select", function () {
      $('head').append( $('<link rel="stylesheet" type="text/css">').attr('href', "/assets/bootstrap-select.min-e875ba735af10d2d9e9d68d2fe6c3cda9fd4693f42c3b2114f8834dc5ed38f73.css") );
        if( !viewport.is('xs') ){
    ...
    $("#" + target + ".modal").on("show.bs.modal", function () {
        ...
        $.ajax({
            ...
            success: function(results){
                ...
                $('head').append( $('<link rel="stylesheet" type="text/css">').attr('href', '/assets/bootstrap-select.min.css') );
...
function socialShare(){
    ...
    if ( socialButtonsEnabled == 1 ){
      $('head').append( $('<link rel="stylesheet" type="text/css">').attr('href', "/assets/jssocials-8b0883d8e254cd86fc46665e6c17048e92904284fba02bdb94536267bf264f83.css") );
      $('head').append( $('<link rel="stylesheet" type="text/css">').attr('href', "/assets/jssocials-theme-minima-31d5ecdab7ca70e756d2c6992135a68a3f678c6aec2cce12ac77a495e7213ae1.css") );
      $.getScript("/assets/jssocials.min-a6575cb18e84386b968f6d287e52551352861146e923c35d76280826f4a358df.js", function( data, textStatus, jqxhr ) {

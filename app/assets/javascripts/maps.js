        ...
        if( optimizedDatabaseLoading == 1 ){
            google.maps.event.addListener(map, 'idle', function(){
                if( searchClicked != 1 ){
                    ...
                    loadData("/assets/data.php", ajaxData);
                }
            });
        }
        else {
            google.maps.event.addListenerOnce(map, 'idle', function(){
                loadData("/assets/data.php");
            });
        }
...
//console.log(infoboxOptions);
            ...
            function renderResults(){
                ...
                if( $(".hero-section").hasClass("sidebar-grid") ){
                    var sidebarUrl = "/assets/sidebar_results_grid.php";
                }
                else {
                    sidebarUrl = "/assets/sidebar_results.php";
                }
...
function simpleMap(_latitude,_longitude, element, markerDrag, place){
    ...
    function drawMap(mapCenter){
        ...
        var marker = new RichMarker({
            ...
            content: "<img src='/assets/marker.png'>",
            flat: true
        });
